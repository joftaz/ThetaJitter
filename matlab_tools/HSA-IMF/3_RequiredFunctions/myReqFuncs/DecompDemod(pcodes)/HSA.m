...
% 	Name: beta
% 	Type: scalar 
% 	Description: scale factor for noise [start at 0 and increase]
% 
% 	Name: L
% 	Type: integer
...
% 	Name: parFlag
% 	Type: logical
% 	Description: utilize parallel parfor loop for ensenble trials [default: false]
%                   if true, it is assumed that a parallel pool is already
%                   configured and open
% 
%  Output Arguments:
% 
