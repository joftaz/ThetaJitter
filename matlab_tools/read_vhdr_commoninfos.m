function header=read_vhdr_commoninfos(filename)

% read_vhdr_commoninfos (filename)  returns a structure with the values
% specified in the Common Infos file of a .vhdr file created by Analyzer 1

%Leon Deouell, HCNL 19/12/2009
% Tamar, Oct 30 2016 - see read_vhdr_commoninfos2 for analyzer version 2

disp( ['Reading ' filename ' header'])
fid=fopen(filename,'r');
s=fgetl(fid);
% check version 
if ~strcmp(s, 'Brain Vision Data Exchange Header File Version 1.0')
