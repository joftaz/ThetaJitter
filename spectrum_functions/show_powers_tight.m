function show_powers_tight(t, freqs, datas, n_col, fig_title, colorbar_title, overlap_data, subject_names, title_y, col_titles, gap,  marg_h, marg_w, is_square)
...
%     imagesc(t,1:size(data,2),data)%,'edgecolor','none');
    args = {t,freqs,zeros(size(data)),data };
